...
// Header Parallax
var headScroll = document.getElementById('bg');
window.addEventListener('scroll', function () {
  /* headScroll.style.opacity = 1 - +window.pageYOffset/650+'' */
  headScroll.style.top = +window.pageYOffset + 'px';
  headScroll.style.backgroundPositionY = 1 - +window.pageYOffset / 2 + 'px';
}); // Navbar Sticky

var stickyNav = document.querySelector('.navbar');
window.addEventListener('scroll', function () {
  stickyNav.classList.toggle('active', scrollY > 0);
}); // Menu

var menuToggle = document.querySelector('.menu_toggle');
var activeMenu = document.querySelector('.navigation');
...
var script = __webpack_require__(598);
...
// Main Styles
 ...
 // Reset default Style and Normalize.css
...
window.onload = function () {
  var grid = document.querySelector('.works_content');
  var masonry = new (masonry_default())(grid);
}; // Swiper slider 
...
new core_class('.testimonial_wrapper', {
  pagination: {
    el: '.swiper-pagination',
    clickable: true
  }
